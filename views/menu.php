...
<nav>
	<div class="nav-wrapper blue">
		...
		<ul class="right hide-on-med-and-down">
			<li><a href="home.php" class="fontePadrao "><i class="left material-icons">home</i>Home</a></li>
			<li><a href="procuraramigos.php" class="fontePadrao"><i class="left material-icons">search</i>Procurar pessoas</a></li>
